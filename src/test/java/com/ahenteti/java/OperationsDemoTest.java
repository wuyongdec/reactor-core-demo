...
public class OperationsDemoTest {

    OperationsDemo workshop = new OperationsDemo();
    ...
    public void zipFirstNameAndLastName() {
        ...
        StepVerifier.create(userFlux).expectNext(User.SKYLER, User.JESSE, User.WALTER, User.SAUL).verifyComplete();
    }
